...
urlpatterns = [
    ...
    path('mentor/settings', views.ProfileSettings.as_view(), name='settings'),
    path('mentor/settings/update_pass', views.ProfileUpdatePassword.as_view(), name='update_password'),
    path('mentor/settings/update_profile', views.ProfileUpdater.as_view(), name='update_profile'),
