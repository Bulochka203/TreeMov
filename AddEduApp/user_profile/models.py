...
class MentorProfile(AbstractProfile):
    ...
    #10 учеников: 400 р/мес, или 2000 р/полгода или 3599 р/год
    #18 учеников: 670 р/мес или 3599 р/полгода или 6699 р/год
    #25 учеников: 862 р/мес или 4795 р/полгода или 7899р/год
    #Доплата за каждого отдельного пользователя - 55 р/мес*
    OFFERS = (
        (0, 'Free'),
        (1, 'Paid-first-stage'),
        (2, 'Paid-second-stage'),
    ...
    offer = models.PositiveIntegerField(help_text="Тариф", default=0, choices=OFFERS)
    def __str__(self):
        return f'{self.first_name } {self.last_name}'
...
class Group(models.Model):
    ...
    chat_link = models.CharField(max_length=255, help_text='Ссылка на чат группы', default=None)
